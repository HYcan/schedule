...
public class DateFormateUtil  {
	private static final Logger log = LoggerFactory.getLogger(DateFormateUtil.class);
	/** 10位日期格式化 ***/
	 ...
	 * 在日期上加second秒，得到新的日期
	 */
	public final static String addSecondToDateTime(Date date,int second){
		Calendar c = Calendar.getInstance();
		c.setTime(date);
