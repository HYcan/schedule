...
public class ReflectUtil {
   ...
   public static Object newObject(Object entity){
	   ConstructorAccess<? extends Object>  access = ConstructorAccess.get(entity.getClass());
   ...
   public static Field getField(Object entity,String fieldName) throws Exception{
  ...
  public static Object getValue(Object entity,Class annotationClass){
   ...
   public static Field getField(Object entity,Class annotationClass) throws Exception{
	   Field field  = null;
	   Field fields [] = entity.getClass().getDeclaredFields();
	   for (Field field_ : fields) {
		    if(field_.isAnnotationPresent(annotationClass)) {
		    	field = field_;
		    	break;
		    }
	   }
