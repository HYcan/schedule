...
import com.ronhe.romp.schedule.core.scheduler.model.XxlJobRegistry;
...
public class JobGroupController {
	...
	private List<String> findRegistryByAppName(String appNameParam){
		...
		List<XxlJobRegistry> list = SchedulerResourceConfig.getAdminConfig().getXxlJobRegistryDao().findAll(RegistryConfig.DEAD_TIMEOUT);
		if (list != null) {
