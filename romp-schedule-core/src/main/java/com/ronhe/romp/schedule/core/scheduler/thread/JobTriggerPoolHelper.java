...
import com.ronhe.romp.schedule.core.scheduler.trigger.XxlJobTrigger;
...
public class JobTriggerPoolHelper {
     ...
     * add trigger
     */
    public void addTrigger(final String jobId, final TriggerTypeEnum triggerType, final int failRetryCount, final String executorShardingParam, final String executorParam) {
